...
def main():
    ...
    if  st.session_state.df is not None:
        ...
        if st.button('Preview dataframe'):
            show_df(st.session_state.df[st.session_state.slider_value_start:st.session_state.slider_value_end+1],
                    st.session_state.x_sel, st.session_state.y_sel)
            visualise_data(st.session_state.df, st.session_state.slider_value_start, st.session_state.slider_value_end)
